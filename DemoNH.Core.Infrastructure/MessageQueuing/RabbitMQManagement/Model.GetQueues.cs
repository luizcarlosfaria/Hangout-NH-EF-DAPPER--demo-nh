...
using DemoNH.Core.Infrastructure.MessageQueuing.RabbitMQManagement.GetQueues.Model;
using RestSharp;
using Spring.Objects.Factory.Attributes;


namespace DemoNH.Core.Infrastructure.MessageQueuing.RabbitMQManagement.GetQueues.Model
{
